...
describe('nthMondayOfMonth', () => {
  ...
  test('first Monday of December 2026 = Mon Dec 7', () => {
  ...
  // Westland Anniversary is the Monday NEAREST 1 December, not the first Monday
  // of December (the two diverge when Dec 1 falls Tue–Thu). 2026: Dec 1 is a
  // Tuesday → nearest Monday is 30 Nov (verified vs employment.govt.nz).
  test('Monday nearest 1 Dec 2026 = Mon Nov 30 (Westland rule)', () => {
    const d = nearestMondayTo(2026, 11, 1);
